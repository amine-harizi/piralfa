    ...
    <div className="dark:bg-slate-900 bg-indigo-100 pt-4 relative max-w-screen">
      <div className="w-5/6 mx-auto main dark:bg-slate-800 dark:text-white">
        <img
          src={corner}
          alt="up-corner"
          className="absolute top-4 left-0 w-8 h-8 md:w-16 md:h-16"
        />
        <img
          src={corner}
          alt="up-corner"
          className="absolute bottom-4 right-0 rotate-180 w-8 h-8 md:w-16 md:h-16"
        />
        <header className="header px-3 items-center mx-auto h-16 bg-white dark:bg-slate-800 flex justify-between">
          ...
          <ul className="flex items-center align-middle">
              ...
              >
                {theme === "dark" ? (
                  <svg
                    ...
                    fill="none"
                    className="hover:fill-slate-100 transition-colors duration-200"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                    <path
                  ...
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    className="hover:fill-slate-500 transition-colors duration-200"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                    <path
            ...
            <li>
              <a
                href=""
                className="mx-4 font-bold transition-all duration-300 contact-btn hover:bg-slate-400 dark:hover:bg-slate-600 rounded"
              >
                Contact
              </a>
            </li>
            <li>
              <a
                href=""
                className="main-btn transition-all duration-200 rounded"
              >
                Purshase
              </a>
            </li>
        ...
        <section className="hero ml-4 flex">
          <div className="text-center">
            <h1 className=" mt-3 text-3xl font-bold md:text-5xl md:mt-8">
              Piralfa
            </h1>
            <h3 className="font-bold text-base md:text-xl  opacity-60 mt-5">
              The best way to make your ideas come true.
            </h3>
            <a
              href=""
              className="rounded main-btn inline-block transition-all duration-200 mt-5"
            >
              Purshase
            </a>
          </div>
          ...
          <img
            src={hero}
            alt="hero"
            className="overflow-hidden mr-10 max-h-96 max-w-96"
          />
        </section>
        ...
        <section className="flex flex-col sm:flex-row justify-around">
          {products.map((product, idx) => {
            return (
              <div
                key={idx}
                className="product relative w-4/5 sm:w-5/12 h-96 mb-7 sm:mb-0 mx-auto"
              >
                <h2>{product.name}</h2>
                <ul>
                ...
                <div className="absolute bottom-0 block">
                  <a
                    href=""
                    className="main-btn bg-gradient-to-r from-yellow-500 to-prin transition-all duratsion-200 rounded  w-24 mb-4 mx-auto"
                  >
                    Purshase
                  </a>
                </div>
        ...
        <section>
          <div className="my-4 text-center flex flex-col sm:flex-row justify-around items-center">
            <h3 className="font-bold mx-1 sm:text-xl dark:opacity-60 text-seco mb-4">
              Feel free to ask us whatever you want, <br /> whenever you want.{" "}
            </h3>
            <div>
              <ul className="opacity-60 sm:font-semibold mx-4">
                <li className="flex my-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-5 w-5 fill-seco mr-2"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                ...
                <li className="flex my-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-5 w-5 mr-2 fill-seco"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
          ...
          <div className="flex flex-col md:flex-row justify-around px-4">
            <form
              action=""
              className="md:w-5/12 flex flex-col px-4 py-4"
              onSubmit={handleContactForm}
            >
              <input
                type="text"
                className="bg-transparent outline-none border-b-2 border-seco focus:border-b-4 transition-all duration-150 my-4 px-2"
              ...
              <textarea
                ...
                className="bg-transparent outline-none ring-1 ring-seco focus:ring-2 h-28 resize-none my-4"
                ref={userMessage}
              ></textarea>
              <button
                type="submit"
                className="flex rounded bg-seco opacity-80 font-bold hover:opacity-100 transition-opacity duration-200 mx-auto items-center align-middle p-2"
              >
            ...
            <img
              src={contact}
              alt="contact-us"
              className="hidden sm:block max-w-sm w-4/12 mx-auto mb-4"
            />
          </div>
          <p
            className={`rounded text-white md:w-1/3 ml-8 mx-4 p-1 ${
              error
                ? "bg-red-500 ring ring-red-400"
                : "bg-green-500 ring ring-green-400"
            }`}
          >
            {message}
          </p>
